...
const FeatureCard = ({ icon, title, description, delay, isVisible, color, index, isMobile }: FeatureCardProps) => {
  return (
    ...
    >
      ...
      <h3 className="text-lg font-bold text-carteBlue-700 mb-1 font-worksans">{title}</h3>
      <p className="text-carteBlue-700 text-xs font-worksans">{description}</p>
    </div>
  );
};
    ...
    >
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <h2 
            className={`text-2xl md:text-3xl font-bold text-carteBlue-700 mb-4 font-worksans ${
          ...
          <p 
            className={`text-base text-carteBlue-700 max-w-xl mx-auto font-worksans ${
