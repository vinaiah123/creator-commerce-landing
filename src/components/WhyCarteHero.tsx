...
const WhyCarteHero = () => {
  ...
  return <section className="py-16 md:py-24 bg-gradient-to-b from-white to-carteBackground" ref={elementRef as React.RefObject<HTMLDivElement>}>
      <div className="container mx-auto px-6">
        ...
        }].map((item, index) => <div key={index} className={`backdrop-blur-xl bg-white/50 rounded-2xl p-8 border border-white/30 shadow-[0_8px_30px_rgba(0,0,0,0.06)] transition-all duration-500 hover:-translate-y-2 hover:bg-white/60 ${isVisible ? `animate-fade-in animation-delay-${300 + index * 100}` : 'opacity-0'}`}>
