    ...
    >
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <span 
            className={`inline-block bg-white text-purple-700 px-4 py-1.5 rounded-full text-sm font-medium mb-4 ${
