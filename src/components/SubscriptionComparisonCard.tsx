...
const SubscriptionComparisonCard = () => {
  return (
    <div className="rounded-3xl p-8 lg:p-10 kawaii-shadow border-2 border-carteYellow/40 bg-gradient-to-br from-white/95 to-carteYellow/10 backdrop-blur-xl">
      <h3 className="text-2xl lg:text-3xl font-bold mb-8 text-center text-carteBlue-700">
        <Sparkles className="inline-block text-carteYellow mr-2" size={24} />
        Switch to Zero Fees with Our Subscription
        <Sparkles className="inline-block text-carteYellow ml-2" size={24} />
      </h3>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
        {/* Carte Plan */}
        <div className="space-y-6">
          <div className="bg-white rounded-2xl p-6 lg:p-8 border-2 border-carteYellow/30 kawaii-shadow animate-float">
            <h4 className="text-xl font-bold mb-4 flex items-center text-carteBlue-700">
              <Heart className="text-carteYellow mr-2" size={24} /> 
              Carte Subscription
            ...
            <div className="space-y-4">
              {['All-in-one platform for creators', 'Complete feature set in one subscription', 'No additional costs as you scale', 'Unlimited products and digital assets', 'Customizable checkout experience', 'Advanced analytics and reporting', 'Priority customer support', 'Secure payment processing', 'API access for custom integrations', 'White-labeled experience'].map((feature, index) => (
                <div key={index} className="flex items-start">
                  <Check size={18} className="text-carteBlue-500 mt-1 mr-2 flex-shrink-0" />
                  <span className="text-carteBlue-700">{feature}</span>
                </div>
              ))}
            </div>
            <div className="mt-6 bg-carteYellow/10 rounded-xl p-4 border-2 border-carteYellow/30">
              ...
              <div className="text-sm text-carteBlue-600 mt-1">No transaction fees on any sales</div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="mt-6 flex items-center justify-center text-lg">
            <TrendingDown size={24} className="text-carteBlue-500 mr-2" />
            <span className="font-bold text-carteBlue-700">Save $192/month with Carte</span>
          </div>
        </div>
      </div>
      
      <div className="mt-10 text-center">
        <Button size="lg" className="bg-carteYellow hover:bg-carteYellow-600 text-carteBlue-700 font-semibold px-8 py-6 h-auto rounded-xl shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-2 border-carteYellow/30">
