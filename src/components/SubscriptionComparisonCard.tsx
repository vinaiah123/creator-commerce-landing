...
const SubscriptionComparisonCard = () => {
  return <div className="rounded-3xl p-8 lg:p-10 kawaii-shadow border-2 border-carteYellow/20 bg-zinc-900/95 backdrop-blur-xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div className="space-y-4">
          ...
          price: '$39/mo'
        }].map((service, index) => <div key={index} className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
