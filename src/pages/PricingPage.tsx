...
const SubscriptionComparisonCard = () => {
  return (
    <div className="rounded-3xl p-8 kawaii-shadow border-2 border-carteYellow/30 bg-zinc-900">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-carteYellow/10 rounded-2xl p-6 border-2 border-carteYellow kawaii-shadow">
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                <Check size={18} className="text-carteYellow mt-1 mr-2 flex-shrink-0" />
                <span className="text-gray-200">All-in-one platform for creators</span>
              </div>
              <div className="flex items-start">
                <Check size={18} className="text-carteYellow mt-1 mr-2 flex-shrink-0" />
                <span className="text-gray-200">Complete feature set in one subscription</span>
              </div>
              <div className="flex items-start">
                <Check size={18} className="text-carteYellow mt-1 mr-2 flex-shrink-0" />
                <span className="text-gray-200">No additional costs as you scale</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <h4 className="text-xl font-bold mb-2 flex items-center text-slate-50">
          ...
          <div className="mt-4 bg-gray-800 rounded-xl p-4 border-2 border-red-800">
            ...
            <div className="text-sm text-red-400 mt-1">+ transaction fees on every sale</div>
          </div>
